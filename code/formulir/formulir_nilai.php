...
<form action="code/proses/input/input_nilai.php" method="POST">
	...
	<tr>
		<td><b>Absensi (0-100)</b></td>
	</tr>

	<tr>
		<td><input type="text" name="absensi" size="25px" maxlength="3" placeholder="ketikkan nilai.." required>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Simpan"></td>
	</tr>

	<tr>
		<td><b>Nilai Tugas (0-100)</b></td>
	</tr>

	<tr>
		<td><input type="text" name="nilai_tugas" size="25px" maxlength="3" placeholder="ketikkan nilai.." required>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Simpan"></td>
	</tr>
	
	<tr>
		<td><b>Nilai UTS (0-100)</b></td>
	</tr>

	<tr>
		<td><input type="text" name="UTS size="25px" maxlength="3" placeholder="ketikkan nilai.." required>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Simpan"></td>
	</tr>

	<tr>
		<td><b>Nilai UAS (0-100)</b></td>
	</tr>

	<tr>
		<td><input type="text" name="UAS" size="25px" maxlength="3" placeholder="ketikkan nilai.." required>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Simpan"></td>
	</tr>

	<tr>
		<td><b>Total Nilai (0-100)</b></td>
	</tr>

	<tr>
		<td><input type="text" name="total_nilai" size="25px" maxlength="3" placeholder="ketikkan nilai.." required>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Simpan"></td>
	</tr>
	</table>
