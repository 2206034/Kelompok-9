...
<table id="daftar-table" border='0' bordercolor="black" cellpading='2' cellspacing='2' width='100%'>
	<tr align='center'>
		...
		<th class="normal">Kelas/Tingkat Kelas</th>
	...
	$tampilkan_isi = "select * from siswa s,kelas j where s.tingkat_kelas=j.tingkat_kelas;";

	if (isset($_POST['cari']) and $_POST['cari'] <> "") {
		$key = $_POST['cari'];
		$tampilkan_isi = "select * from siswa s,kelas j where s.tingkat_kelas=j.tingkat_kelas AND nama_siswa LIKE '%$key%'";
	...
	?>
		<tr class="isi" align='left'>
			...
			<td><?php echo $kelas ?> | <?php echo $kelas ?></td>
