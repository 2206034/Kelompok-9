<body>
    ...
    if ($aksi == "delete") {
        ...
        $query = mysqli_query($connect, "select * from siswa s,kelas j where s.tingkat_kelas=j.tingkat_kelas and nis='$nis';");
    ?>
        ...
        <form action="code/proses/update-delete/update/update_siswa.php" method="POST">
            ...
            <table id="tabel-pendaftaran">
                ...
                ?>
                    ...
                    <tr>
                        <td><input type="text" name="tingkat_kelas" size="25px" maxlength="15" style="background-color:#E0DFDF" value="<?php echo $isi['tingkat_kelas']; ?> | <?php echo $isi['kelas']; ?>" readonly></td>
                    </tr>
