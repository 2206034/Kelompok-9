...
<form action="halaman_utama.php?informasi_nilai=$informasi_nilai" method="post">
	...
	font-family:Calibri;
		...
		<tr>
			<td></td>
			<td align="right">
				<font face="Calibri" size="2"><u>Harap gunakan <b>Mata Pelajaran</b> dalam pencarian Nilai</u> !</font>
			</td>
		</tr>
	</table>
</form>
	...
	?>
		<tr class="isi" align='left'>
			...
			<td>
				...
				} else if ($angka_nilai >= 85 and $angka_nilai <= 100) {
					echo "A";
				}  else if ($angka_nilai >= 75 and $angka_nilai <= 85) {
					echo "B";
				}  else if ($angka_nilai >= 65 and $angka_nilai <= 70) {
					echo "C";
